...
class DocumentSupportState
    extends BaseTableScreenState<DocumentInfo, DocumentSupport> {
  @override
  ...
  List<TableColumnConfig> buildColumns() {
    return [
      TableColumnConfig(
        ...
        valueBuilder: (data) =>
            (data as DocumentInfo).documentSerialNumber ?? '-',
      ),
      TableColumnConfig(
        header: '문서명',
      ...
      TableColumnConfig(
        ...
        valueBuilder: (data) =>
            (data as DocumentInfo).documentDescription ?? '-',
      ),
      TableColumnConfig(
        header: '첨부일자',
